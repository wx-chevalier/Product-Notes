...
public class SyncContext {
    ...
    public void responseHandler(InjectableWorkerWithUniResourceBag worker) {
        ...
        try {
            ...
            //判断是否为自己抛出的异常
            if (throwable.getCause() instanceof LFThrowable) {


                this.uniResourceBag.setResponseData((LFThrowable) throwable.getCause());
                ...
                LFThrowable lfThrowable = new LFThrowable.Builder().code(ErrorConfig.CODE_INTERNEL_EXCEPTION).desc("内部错误").build();
