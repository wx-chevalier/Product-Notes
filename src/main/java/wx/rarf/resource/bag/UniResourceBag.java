...
public class UniResourceBag {
    ...
    public void setResponseData(LFThrowable lfThrowable) {

        this.responseData = new ResponseData(lfThrowable);
    ...
    public static JSONObject parseRequestData(HttpServletRequest httpServletRequest, String... mustKeys) throws LFThrowable {
        ...
        try {
            ...
            if (requestData == null) {
                throw new LFThrowable.Builder().code(ErrorConfig.CODE_1005).desc("请求参数缺失").build();
            }
            ...
            throw new LFThrowable.Builder().code(ErrorConfig.CODE_1005).desc("请求数据格式错误").build();
        }
