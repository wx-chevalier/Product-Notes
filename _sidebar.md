  ...
  - [4 定义与设计](/定义与设计/README.md)
    ...
    - [4.3 需求与沟通](/定义与设计/需求与沟通/README.md)
      ...
      - [4.3.2 用户触达与调研](/定义与设计/需求与沟通/用户触达与调研/README.md)
    ...
    - [4.4 价值主张](/定义与设计/价值主张/README.md)
      - [4.4.1 价值假设与验证](/定义与设计/价值主张/价值假设与验证/README.md)
        - [4.4.1.1 客户概况和价值图](/定义与设计/价值主张/价值假设与验证/客户概况和价值图.md)
      - [4.4.2 商业模式画布](/定义与设计/价值主张/商业模式画布/README.md)
